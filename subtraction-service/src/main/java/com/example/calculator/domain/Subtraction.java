...
public class Subtraction {
    ...
    private static final Logger LOG = LoggerFactory.getLogger(Subtraction.class.getName());
    ...
    public Number apply(String mathOperation) {
        ...
        throw new UnsupportedOperationException("The " + mathOperation + " is not a subtraction");
    }

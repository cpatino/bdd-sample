...
public class Addition {
    ...
    private static final Logger LOG = LoggerFactory.getLogger(Addition.class.getName());
    ...
    public Number apply(String mathOperation) {
        ...
        throw new UnsupportedOperationException("The " + mathOperation + " is not an addition");
    }
